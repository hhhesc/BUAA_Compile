...
public class RelExp extends SyntaxTreeNode {
    public RelExp(SyntaxTreeNode parent) {
        super(SyntaxNodeType.RelExp, parent);
    }
    ...
    public Value toIR() {
        if (children.size() == 1) {
            ...
            return new Icmp(children.get(1).getFirstLeafString(),
                    children.get(0).toIR(), children.get(2).toIR());
        }
    }
}
